                ...
                <div className="fixed inset-0 z-10 overflow-y-auto">
                        <div className="flex min-h-full justify-center p-4 text-center sm:p-0">
                            ...
                            >
                                ...
                                >
                                    <div className="absolute right-0 top-0 hidden pr-4 p4-4 sm:block z-10">
                                        <button type="button" className="rounded-md bg-white text-gray-400 hover:txt-gray-500 focus:online-none focus:ring-2 focus:ring-sky-500 focus:right-offset-2"
                                        onClick={onClose}
                                        >
